...
<body>
	...
	<div class="bg-white shadow p-4 rounded lg:w-64">
		<div class="text-center mt-4">
			<p class="text-grey-dark font-bold">Your Name</p>
			<p class="text-sm font-hairline text-grey-dark mt-1">タイプ</p>
			</div>
			...
			<div class="mt-6"><button class="rounded shadow-md w-full items-center shadow bg-blue-500 px-4 py-2 text-white hover:bg-blue-light">
			Follow
			</button>
		</div>
	</div>
